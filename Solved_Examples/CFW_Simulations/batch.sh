...
rm ./CFW_main
# Your code below this line
nvfortran -fopenmp -fast -g -Minfo=accel -acc -gpu=managed -O3 -o CFW_main ./CFW_src/global.cuf ./CFW_src/Kernel.cuf ./CFW_src/cuFFT2D.cuf ./CFW_src/norms.cuf ./CFW_src/main.cuf -lcufft
